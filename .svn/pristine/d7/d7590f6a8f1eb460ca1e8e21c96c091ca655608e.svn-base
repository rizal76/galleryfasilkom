	...
	<script type="text/javascript" src="<?php echo base_url();?>resource/js/jquery.pikachoose.js"></script>
		<article id="content-column">
			<h1>Detecting Plagiarism Among a Set of Very Similar Programs</h1><br/>
<div><i>Published in Gallery at 31 Oct 2012</i></div><br/>
			...
			<section id="desc">
				<h3>Description</h3>
				<p>
				An algorithm to detect similarity in a set of already similar source codes is an important issue for many educational institutions. In teaching programming courses, students are asked to solve a specific problem. Thus, all of the submit-ted programs already have an inherent similarity: they are written to solve the same problem. The algorithm  proposed in this document is specifically designed to detect plagiarism within a set of of already similar source codes and assess the statistical significance of the calculated similarity.
				</p>
			</section>
			<section id="photos">
				<!--
				...
				<tr>
					<td width="400">
						...
						<p>
							...
							<ul>
								<li>Tisha Melia</li>
								<li>Ricky Suryadharma</li>
								<li>Budianto</li>
								<li>Denvil Prasetya</li>
							</ul>

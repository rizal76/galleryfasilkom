	...
	<script type="text/javascript" src="<?php echo base_url();?>resource/js/jquery.pikachoose.js"></script>
		<article id="content-column">
			...
			<section id="desc">
				<h3>Description</h3>
				<p>
				Hanacaraka is an Android application that helps the users 
				learn how to read and write Javanese script. It can help users identify and understand the Javanese
				script, learn how to read, and ultimately help the users know how good are their
				ability in understanding the Javanese script.</p>
				<p>Main feature:<br/>
					<ol>
			...
			<section id="photos">
				...
				<div class="pikachoose">
					<ul id="pikame" class="jcarousel-skin-pika">
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/Hanacaraka/ss1.jpg"/></a><span>Hanacaraka</span></li>
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/Hanacaraka/ss2.jpg"/></a><span>Hanacaraka</span></li>
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/Hanacaraka/ss3.jpg"/></a><span>Hanacaraka</span></li>
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/Hanacaraka/ss4.jpg"/></a><span>Hanacaraka</span></li>
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/Hanacaraka/ss5.jpg"/></a><span>Hanacaraka</span></li>
					</ul>
				</div>

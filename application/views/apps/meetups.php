	...
	<script type="text/javascript" src="<?php echo base_url();?>resource/js/jquery.pikachoose.js"></script>
		<article id="content-column">
			...
			<section id="desc">
				<h3>Description</h3>
				<p>
				Meetup is a community management application that tries to facilitate small communities are difficult to manage meeting schedules, synchronize empty schedule members. Meetup is currently focusing on how a community will no longer need the old debate about when to have a meeting. Meetup will help provide recommendations appointments and a constant reminder in every community meeting that followed someone.</p>
			...
			<section id="photos">
				...
				<div class="pikachoose">
					<ul id="pikame" class="jcarousel-skin-pika">
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/meetups/Screenshot_2013-01-04-21-52-07.png"/></a><span>MeetUps</span></li>
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/meetups/Screenshot_2013-01-04-21-52-13.png"/></a><span>MeetUps</span></li>
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/meetups/Screenshot_2013-01-04-21-52-25.png"/></a><span>MeetUps</span></li>
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/meetups/Screenshot_2013-01-04-21-52-41.png"/></a><span>MeetUps</span></li>
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/meetups/Screenshot_2013-01-04-21-52-45.png"/></a><span>MeetUps</span></li>
					</ul>
				</div>

	...
	<script type="text/javascript" src="<?php echo base_url();?>resource/js/jquery.pikachoose.js"></script>
		<article id="content-column">
			<h1>NotePedia</h1><br/>
			<div><i>Published in Gallery at 31 Oct 2012</i></div>
			<div><i>Published in Nokia Ovi Store at 28 Jul 2011</i></div><br/>
			<!--
			<section id="video">
			...
			<section id="desc">
				<h3>Description</h3>
				<p>
				NotePedia is a quick note application for everyone, especially students. 
				NotePedia features are taking notes, searching notes, categorizing notes, exporting notes to .txt file, importing notes to share, and the user can have private note.
				Create your very own encyclopaedia!
				</p>
			</section>
			<section id="photos">
				<h3>Screenshots</h3>
				...
				<div class="pikachoose">
					<ul id="pikame" class="jcarousel-skin-pika">
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/Nokia/NotePedia/ss1.png"/></a><span>NotePedia</span></li>
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/Nokia/NotePedia/ss2.png"/></a><span>NotePedia</span></li>
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/Nokia/NotePedia/ss3.png"/></a><span>NotePedia</span></li>
					</ul>
				</div>
			...
			<table>
				<tr>
					<td width="500">
						...
						<h3>Team</h3>
						<p>
							Initiated as submission for Nokia TapThatApp Competition, by Team ART:<br/>
							<ul>
								<li>Muhammad Rezqi</li>
								<li>Raden Agung Yuga Dwitama</li>
								<li>Mochammad Tri Rahmady</li>
							</ul>
						</p>
						</section>
					</td>
					<td style="vertical-align:top">
						...
						<h3>More</h3>
						<p>
						<a href="http://store.ovi.com/content/157867">Nokia Ovi Store</a>
						</p>
						</section>
					</td>
				</tr>

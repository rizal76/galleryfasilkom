	...
	<script type="text/javascript" src="<?php echo base_url();?>resource/js/jquery.pikachoose.js"></script>
		<article id="content-column">
			<h1>Antarnusa, One Stop Solution for Your Travel</h1><br/>
			...
			<section id="desc">
				<h3>Description</h3>
				<p>
				AntarNusa is a web-based application to simplify the user to buy flight tickets using the Host-to-Host system. This payment system is chosen to expand the customer target, so the customers can pay without using credit cards.
				</p>
			</section>
			<section id="photos">
				<!--
				...
				<tr>
					<td width="400">
						...
						<p>
							...
							<ul>
								<li>Ade Saputra</li>
								<li>Niken Listya P</li>
								<li>Ridwan Mulyadi</li>
								<li>Rizky Yudha</li>
								<li>Vit Zuraida</li>
							</ul>
						</p>

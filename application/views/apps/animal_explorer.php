	...
	<script type="text/javascript" src="<?php echo base_url();?>resource/js/jquery.pikachoose.js"></script>
		<article id="content-column">
			...
			<section id="desc">
				<h3>Description</h3>
				<p>
				Animex (Animal Explorer) is a game that entertain the children because they can take care of their virtual pets on their phones.
				They can learn how to treat their pets in a good way.
				</p>
			</section>
			<section id="photos">
				<h3>Screenshots</h3>
				...
				<div class="pikachoose">
					<ul id="pikame" class="jcarousel-skin-pika">
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/Nokia/Animal Explorer/ss1.png"/></a><span>Animal Explorer</span></li>
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/Nokia/Animal Explorer/ss2.png"/></a><span>Animal Explorer</span></li>
					</ul>
				</div>
			...
			<table>
				<tr>
					<td width="500">
						...
						<h3>Team</h3>
						<p>
							Initiated as submission for Nokia TapThatApp Competition, by Team Animex:<br/>
							<ul>
								<li>Angga Aditya</li>
								<li>Latifaah</li>
							</ul>
					...
					<td style="vertical-align:top">
						...
						<h3>More</h3>
						<p>
						<a href="http://store.ovi.com/content/172349">Nokia Ovi Store</a>
						</p>
						</section>
					</td>
				</tr>

	...
	<script type="text/javascript" src="<?php echo base_url();?>resource/js/jquery.pikachoose.js"></script>
		<article id="content-column">
			<h1>HanWrite</h1><br/>
			<div><i>Published in Gallery at 22 Nov 2012</i></div>
			<div><i>Published in Nokia Ovi Store at 23 Jul 2011</i></div><br/>
			...
			<section id="desc">
				<h3>Description</h3>
				<p>
				HanWrite is an educative application that let the user to practice writing chinese words or characters.
				</p>
			</section>
			<section id="photos">
				<h3>Screenshots</h3>
				...
				<div class="pikachoose">
					<ul id="pikame" class="jcarousel-skin-pika">
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/Nokia/HanWrite/ss1.jpg"/></a><span>HanWrite</span></li>
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/Nokia/HanWrite/ss2.jpg"/></a><span>HanWrite</span></li>
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/Nokia/HanWrite/ss3.jpg"/></a><span>HanWrite</span></li>
					</ul>
				</div>
			...
			<table>
				<tr>
					<td width="500">
						...
						<h3>Team</h3>
						<p>
							Initiated as submission for Nokia TapThatApp Competition, by Team T_PHI:<br/>
							<ul>
								<li>Willy Halim Dinata</li>
					...
					<td style="vertical-align:top">
						...
						<h3>More</h3>
						<p>
						<a href="http://store.ovi.com/content/158780">Nokia Ovi Store</a>
						</p>
						</section>
					</td>
				</tr>

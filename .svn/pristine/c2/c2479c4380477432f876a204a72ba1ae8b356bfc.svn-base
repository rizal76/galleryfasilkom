	...
	<script type="text/javascript" src="<?php echo base_url();?>resource/js/jquery.pikachoose.js"></script>
		<article id="content-column">
			...
			<section id="desc">
				<h3>Description</h3>
				<p>
				Backpacom give the user facility to sharing information and discuss about trip to various place in the world. User can share information about  				their tour. With backpacom user can search information of a tour place very easily. User can share all of their experience and their tips for 	   				doing that tour. User can also be make planning consist of luggage, schedule, and budget their needs.</p>
			...
			<section id="photos">
				...
				<div class="pikachoose">
					<ul id="pikame" class="jcarousel-skin-pika">
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/backpacom/login 480x800.png"/></a><span>Backpacom</span></li>
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/backpacom/home 480x800.png"/></a><span>Backpacom</span></li>
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/backpacom/Edit Profile 480x800.png"/></a><span>Backpacom</span></li>
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/backpacom/Edit Account 480x800.png"/></a><span>Backpacom</span></li>
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/backpacom/Account 480x800.png"/></a><span>Backpacom</span></li>
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/backpacom/Messages 480x800.png"/></a><span>Backpacom</span></li>
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/backpacom/New Plan 480x800.png"/></a><span>Backpacom</span></li>
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/backpacom/Next Trip 480x800.png"/></a><span>Backpacom</span></li>

<div id="sidebar">
<h1 style="padding-bottom:20px">Games</h1>
	<nav>
		<ul class="sidebar-nav">
			<li><a <?php if ($sidebar == 'tap_the_beat') { ?> class="current" <?php } ?> href="<?php echo site_url('games/tap_the_beat');?>">Tap The Beat</a></li>
			<li><a <?php if ($sidebar == 'room_of_disaster') { ?> class="current" <?php } ?> href="<?php echo site_url('games/room_of_disaster');?>">Room of Disaster</a></li>

	...
	<script type="text/javascript" src="<?php echo base_url();?>resource/js/jquery.pikachoose.js"></script>
		<article id="content-column">
			...
			<section id="desc">
				<h3>Description</h3>
				<p>
				KabarUI is news portal and radio streaming application which talk about Universitas Indonesia. In this version, only AnakUI.com and RTC UI are integrated into KabarUI. We will add more news portal and source to KabarUI. Stay tuned!</p>
				<p>Main feature:<br/>
					<ol>
						<li>AnakUI.com as main news portal</li>
						<li>Radio streaming provided by RTC UI</li>
						<li>Auto-fetch news</li>
						<li>Notification in the home screen</li>
						<li>You can read previously accessed news offline!</li>
						<li>Navigate news category by using voice or accelerometer sensor</li>
					</ol>
				</p>
			</section>
			<section id="photos">
				...
				<div class="pikachoose">
					<ul id="pikame" class="jcarousel-skin-pika">
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/kabar_ui/Screenshot1.png"/></a><span>Kabar UI</span></li>
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/kabar_ui/Screenshot2.png"/></a><span>Kabar UI</span></li>
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/kabar_ui/Screenshot3.png"/></a><span>Kabar UI</span></li>

	...
	<script type="text/javascript" src="<?php echo base_url();?>resource/js/jquery.pikachoose.js"></script>
		<article id="content-column">
			...
			<section id="desc">
				<h3>Description</h3>
				<p>
				SMSpot is an android application that act as SMS Gateway, where the one that become the server is the android , and the one that become the client is another device such as android or PC. The client send message with their device that is connected to the server via wifi, the message is sent to the server via wifi then the server send the message to the destination.</p>
				<p>Main feature:<br/>
					<ol>
						<li>SMS gateway : Main feature of SMSpot</li>
						<li>Multiple Number : SMSpot server can send message to multiple number.</li>
						<li>Authentication : SMSpot can limit the client who use this service using a key.</li>
						<li>Logging : SMSpot log all the message that sent by the server.</li>
					</ol>
				</p>
			</section>
			<section id="photos">
				...
				<div class="pikachoose">
					<ul id="pikame" class="jcarousel-skin-pika">
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/smspot/client_1_320x480.png"/></a><span>SMSpot</span></li>
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/smspot/client_2_320x480.png"/></a><span>SMSpot</span></li>
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/smspot/client_3_320x480.png"/></a><span>SMSpot</span></li>
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/smspot/client_4_320x480.png"/></a><span>SMSpot</span></li>
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/smspot/client_5_320x480.png"/></a><span>SMSpot</span></li>

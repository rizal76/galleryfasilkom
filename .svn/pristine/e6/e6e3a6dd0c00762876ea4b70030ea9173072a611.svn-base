	...
	<script type="text/javascript" src="<?php echo base_url();?>resource/js/jquery.pikachoose.js"></script>
		<article id="content-column">
			<h1>Pheris: Personal Therapy and Self-Learning Application on Integrated System</h1><br/>
			...
			<section id="desc">
				<h3>Description</h3>
				<p>
				Pheris is an abbreviation of Personal Therapy and Self-Learning Application on Integrated System for deaf people.
Pheris was created in 2012 by the students in Faculty of Computer Science, Universitas Indonesia.
Our main goal in creating Pheris is to build an easy self-learning application for deaf people, especially the deaf kids.
There are many features in Pheris such as Hearing Therapy, Speech Therapy, Music Therapy, Guess Words and Guess Picture.
Hence, Pheris may help them to train the correct pronunciation and to improve their communication skills in the future.
We sincerely hope that our contribution for helping deaf kids will be beneficial for future deaf therapy.
				</p>
			</section>
			<section id="photos">
				<!--
				...
				<tr>
					<td width="400">
						...
						<p>
							...
							<ul>
								<li>Gilang Kusuma Jati</li>
								<li>I Putu Satwika </li>
								<li>Pinkie Anggia </li>
								<li>Ranny Fransiska</li>
							</ul>
						</p>
						</section>
					</td>

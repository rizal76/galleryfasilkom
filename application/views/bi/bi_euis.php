	...
	<script type="text/javascript" src="<?php echo base_url();?>resource/js/jquery.pikachoose.js"></script>
		<article id="content-column">
			<h1>EUIS: Enterprise University Information System</h1><br/>
			<div><i>Published in Gallery at 23 Nov 2012</i></div><br/>
			<section id="video">
				<!--
			...
			<table>
				<tr>
					<td width="400">
						...
						<p>
							...
							<ul>
								...
								<li>Wulung Pambuko</li>
								<li>M Zaki Rahman</li>
								<li>Rakhmad Azhari</li>
								<li>A.C. Arsyady</li>
								<li>Rimphy Darmanegara</li>
								<li>Respati Hafidz Budi</li>
								<li>Kastin Tinara</li>
							</ul>
						</p>
						</section>
					...
					<td style="vertical-align:top">
						...
						<h3>More</h3>
						<p>
							<a href="http://euis.csc.ui.ac.id/" title="EUIS Homepage">EUIS Homepage</a><br/>
							<!--<a href="http://hoodemia.com/" title="Social Network">Hoodemia</a><br/>-->
						</section>
					</td>
				</tr>
			</table>

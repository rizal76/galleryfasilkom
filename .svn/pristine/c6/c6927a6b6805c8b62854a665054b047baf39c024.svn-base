	...
	<script type="text/javascript" src="<?php echo base_url();?>resource/js/jquery.pikachoose.js"></script>
		<article id="content-column">
			...
			<section id="desc">
				<h3>Description</h3>
				<p>
				This application let the users write notes about their activities, thus they can have good track about their days.
				</p>
			</section>
			<section id="photos">
				<h3>Screenshots</h3>
				...
				<div class="pikachoose">
					<ul id="pikame" class="jcarousel-skin-pika">
						<li><a href="#"><img src="<?php echo base_url();?>resource/images/Nokia/cloud_miimo.jpg"/></a><span>Cloud Miimo</span></li>
					</ul>
				</div>
			...
			<table>
				<tr>
					<td width="500">
						...
						<h3>Team</h3>
						<p>
							Initiated as submission for Nokia TapThatApp Competition, by:<br/>
							<ul>
					...
					<td style="vertical-align:top">
						...
						<h3>More</h3>
						<p>
						<a href="http://store.ovi.com/content/163083">Nokia Ovi Store</a>
						</p>
						</section>
					</td>
				</tr>
